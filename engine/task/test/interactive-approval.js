...
try {
  const result = spawnSync(process.execPath, [path.resolve('tools/task/index.js'), 'approve-partial'], { stdio: 'inherit', env: { ...process.env, TASK_STATE_FILE: file } });
